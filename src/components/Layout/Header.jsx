...
const Header = () => {
  ...
  return (
    <header className="bg-transparent backdrop-blur-md sticky top-0 z-50 border-b border-green-500/10 animate-slide-up">
      <div className="container mx-auto px-6">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-3 animate-fade-in" style={{animationDelay: '0.6s'}}>
            <button className="px-6 py-2.5 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-lg font-semibold hover:shadow-lg hover:shadow-green-500/50 transition-all duration-300 hover:scale-110 animate-glow relative overflow-hidden group">
